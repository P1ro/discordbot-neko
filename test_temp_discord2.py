...
if __name__ == '__main__':
    ...
    client = DiscordPy(logic_fun=logic_function, on_message_fun=on_message_function, token='MTEzNTAyMjc5MjQyNTg2NTI5Ng.GqhBZ_.FwF4E4lRtppclPgUhPIRDdhzusQKUdOI45tvAs', channel_id=955667648845316146)
